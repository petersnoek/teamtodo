    ...
    <div style="margin-bottom: 20px;" class="col-md-8">
        <div class="card">
            <div class="card-header"><p style="margin: 7px 0;float: left;">Add User</p>
                <form style="float: right;" method="post" action="{{url('store/todo/task')}}">
                    @csrf
                    <input hidden type="text" name="todo_id" value="{{ $todo->id }}">
                    <input style="width: 200px;display: inline-block;" type="text" class="form-control" name="content" placeholder="Add user...">
